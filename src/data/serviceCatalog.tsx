...
export const SERVICES_CATALOG: ServiceDetail[] = [
  ...
  {
    slug: 'warehousing',
    icon: ICON(['M3 9.5L12 3l9 6.5V21H3V9.5z', 'M9 21V12h6v9']),
...
export const FREIGHT_CATALOG: ServiceDetail[] = [
  ...
  {
    slug: 'ocean-freight',
    icon: ICON(['M12 3v4', 'M3 17l2-6h14l2 6H3z', 'M1 21h22', 'M7 11V7a5 5 0 0110 0v4']),
    title: 'Ocean Freight',
  ...
  {
    slug: 'road-freight',
    icon: ICON(['M9 17a2 2 0 11-4 0 2 2 0 014 0zm10 0a2 2 0 11-4 0 2 2 0 014 0z', 'M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l1 1h1m8-1V8h3l3 3v4l1 1h-1m-6 0h-3']),
    title: 'Road Freight',
  ...
  {
    slug: 'soc-movements',
    icon: ICON('M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9'),
    title: 'SOC Movements',
...
export const CUSTOMS_CATALOG: ServiceDetail[] = [
  ...
  },
  {
    ...
    icon: ICON('M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5'),
  ...
  },
  {
    ...
    icon: ICON(['M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z', 'M4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z']),
